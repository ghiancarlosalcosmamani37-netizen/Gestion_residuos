...
$pagina = $empleados->mostrarConductorSuspendidoC();
$empleados->borrarConductorC();
$empleados->QArchivarConductorC();
?>
								...
								<tbody>
									<tr>
										...
										<td><a class="btn btn-danger btn-sm waves-effect waves-light" href='index.php?ruta=ConductorLista&ID=<?= $value['ID']  ?> '>
											...
											<a class="btn btn-primary btn-sm waves-effect waves-light" href='index.php?ruta=ConductorSuspendido&ID1=<?= $value['ID'] ?>'>
