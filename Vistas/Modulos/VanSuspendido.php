<?php
$empleados = new VanC();
$pagina = $empleados->mostrarVanSuspendidoC();
$empleados->borrarVanC();
$empleados->QArchivarVanC();
?>
								...
								<tbody>
									<tr>
										...
										<td><a class="btn btn-danger btn-sm waves-effect waves-light" href='index.php?ruta=VanLista&IDV=<?= $value['IDV']  ?> '>
											...
											<a class="btn btn-primary btn-sm waves-effect waves-light" href='index.php?ruta=VanSuspendido&IDV1=<?= $value['IDV'] ?>'>
